...
The complete dataset contains sensitive human health and biometric information and therefore remains controlled access. Prospective users should:

1. contact `202531061032@mail.bnu.edu.cn`;
2. provide verifiable identity and institutional contact information;
3. review and sign the Data Use Agreement;
4. provide institutional ethics documentation when required by the data provider or the applicant's institution;
5. receive the approved versioned release through the controlled delivery route.

Access controls are intended to protect participants, not to screen applicants by nationality, institution type, or scientific viewpoint. Intended use may be recorded for governance and audit purposes, but approval focuses on identity, data protection, and agreement to the DUA.
